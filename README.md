...
- Keep structured metadata in [ideas.json](ideas.json) synchronized with the markdown log.
...
Infrastructure and provisioning workflows live in [mach4-braai/infra](https://github.com/mach4-braai/infra).
